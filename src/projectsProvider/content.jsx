...
export function Lima() {
	return (
		<Main>
			...
			<Pic img="/cat/lima/aeropuerto.png" className="ph3 pt3 mw68 center" imgClass="ba b--black" />
	...
	return (
		<Main>
			<section className="grid-3 ph3 pt3">
				<div><img src="/cat/photo/mc/mc4.jpg" alt="mental" /></div>
				
				<div><img src="/cat/photo/mc/mc1.jpg" alt="mental" /></div>
				
				<div><img src="/cat/photo/mc/mc2.jpg" alt="mental" /></div>
				
				<div><img src="/cat/photo/mc/mc3.jpg" alt="mental" /></div>
				
				<div><img src="/cat/photo/mc/mc5.jpg" alt="mental" /></div>
				
				<div><img src="/cat/photo/mc/mc6.jpg" alt="mental" /></div>
	...
	return (
		<Main>
			<section class="grid-3 ph3 pt3">
				<div><img src="/cat/photo/je/je1.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je2.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je3.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je4.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je5.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je6.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je7.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je8.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je9.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je10.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je11.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je12.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je13.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je14.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je15.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je16.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je17.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je18.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je19.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je20.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je21.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je22.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je23.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je24.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je25.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je26.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je27.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je28.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je29.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je30.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je31.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je32.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je33.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je34.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je35.jpg" alt="je" /></div>
				
				<div><img src="/cat/photo/je/je36.jpg" alt="je" /></div>
...
export function Tokyo() {
	return (
		<Main>
			<Pic img="/cat/tokyo/tokyo_1.png" className="pa3 mw8 center" imgClass="ba b--black" />
...
export function Svolta() {
	return (
		<Main>
			<section className="grid-3 ph3 pt3">
				<div><img src="/cat/photo/st/st1.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st2.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st3.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st4.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st5.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st6.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st7.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st8.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st9.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st10.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st11.jpg" alt="svolta" /></div>
				
				<div><img src="/cat/photo/st/st12.jpg" alt="svolta" /></div>
	...
	return (
		<Main>
			...
			<div className="flex ph3 pt3 flex-column-m">
				...
				<Pic img="/cat/prigioniere/expo_3.jpg" className="pr2 pl2 pr0-m pl0-m pb3-m" />
			...
			<div className="flex ph3 pt3 flex-column-m">
				...
				<Pic img="/cat/prigioniere/expo_5.jpg" className="pr2 pl2 pr0-m pl0-m pb3-m" />
...
export function Numeriprimi() {
	return (
		<Main>
			...
			<Par>
				<Sec title="Layout" />
				<ParImg oneimg="/cat/numeriprimi/primi_3.png" className="ba b--light-silver" />
...
export function ManinP() {
	return (
		<Main>
			...
			<Img oneimg="/cat/manin/manin_7.png"
