  ...
  return (
    <Main>
      ...
      <Par>
        ...
        to comprehend the vastness and complexity of the system, and its actual
        wayfinding.
        <Br />
        <Br />
      ...
      <Iltr img="/cat/lima/simplon.png">
        ...
        <P>
          ...
          standards body DIN - Deutsches Institut für Normung (German Institute
          for Standardization), in the standard typefaces sheet published in
          1931. Originally designed for industrial uses, the first DIN-type
          fonts were a simplified design that could be applied with limited
          technical difficulty. Due to the design’s legibility and
          uncomplicated, unadorned design, it has become popular for general
      ...
      <Par>
        ...
        underground geography directly to the aboveground geography. Such design
        moves away from the idea that the representation has to follow the
        actual geographical route of the lines. By replacing the strict
        geographically imposed rules, that requires that entities represented be
        placed exactly where they are located in the physical world, with a
        ...
        lines and the sequence of stations. In this way, the map turns out to be
        an useful support in gaining an understanding of the complexities of the
        underground lines, and an aid in travel planning. For these reasons it
        can act as a navigation tool to assist in working one’s way through the
        underground maze of lines and stations and as a reference once a journey
        is underway.
      </Par>
  ...
  return (
    <Main>
      ...
      <Par className="pb3">
        ...
        decided to widen its audience, gaining a spot into everyday people’s
        lives. Plates, china-ware, phone covers and stationery—labelled with the
        iconic colours—made their way to the masses. We thought this was not
        enough. Why not to take a step forward? Instead of being a mere
        ornament, why shouldn’t it be given the chance to become the essence as
        well? During one of the foremost design-focused events, the Milan Design
        Week/Salone Del Mobile 2018, we offer the hundreds of thousands visitors
        who will gather in the city throughout the week the possibility to dive
        into a whole new coloured sociality. The audience will be able to taste
        six specially crafted cocktails, based on cherry-picked swatches in an
        accurately designed space, thoroughly immersed in the electric vibe of
        the Fuorisalone. For the entire week we will transform a completely
        empty space—in the heart of the event—into an incubator of the new{' '}
        <span className="b helvetica fw7">PANTONE</span> experience, where the
        visitors will have the chance to enjoy the peculiar beverages immersed
        into a carefully customised environment. The brand in its decades-long
        practice managed to impose itself as the standard in the design
        community; which focus has shifted from a very technical point of view
        towards a more liquid attitude. It is essential to allow the trademark
        to propose itself under a whole new light, with new communication assets
        able to ink the way into the future of design again.
        <Sec
        ...
        designers and architects, it might be difficult to believe, but we
        cannot do everything by ourselves. So, for the sake of best practices,
        we endorse collaborations with third party companies we trust, who will
        provide the necessary experience and skills not directly available. We
        have in mind an iconic space carefully designed by our team of
        architects, and furnished by our interior designers, with lightweight
        but essential interventions customised according to the company’s needs
        and identity, but keeping the users in the centre. The space we want to
        build will attract and welcome as many visitors as possible, allowing
        them to fully enjoy what we call the new{' '}
        <span className="b helvetica fw7">PANTONE</span> Experience: they will
...
export function Castiglioni() {
  return (
    <Main>
      <Par>
        <Sec title="ACF" />
        The Achille Castiglioni Foundation was set up in 2012 at the initiative
        of Achille’s heirs. It sets out to foster the work carried out in the
        studio museum located on Piazza Castello 27, evidence of the cultural,
        artistic and professional work of Achille Castiglioni. The Foundation is
        in charge of managing and using preserve, communicate and exhibit,
        objects related to the work carried dissemination activities and
        organises cally, its facilities are meant to effectively talents.
      </Par>
  ...
  return (
    <Main>
      ...
      <Iltr img="/cat/dp/dp_2.png">
        ...
        <Tit tit="Gill Sans" />
        <P>
          Gill Sans is a humanistic sans serif family that, while is considered
          by many to be quintessentially British in tone and concept, has been
          used in virtually every country and in nearly every application
          imaginable. Gill Sans has reached this level of near-ubiquity for one
          simple—and very good—reason: it is an exceptionally distinctive design
          with a potential range of use that is almost limitless.
          <Br />
          Gill Sans was designed by Eric Gill: a versatile, brilliant, and
          prolifically successful designer of the early part of the last
          century. One of the main reasons for the enduring success of his
        ...
        <P>
          Theodore Low DeVinne, publisher of Century Magazine, commissioned Linn
          Boyd Benton to design a new typeface for the magazine. The result, in
          1894, was a roman type called Century Roman; a large x-height gave
          Century Roman the appearance of being condensed. Benton’s son, Morris
          Fuller Benton, redrew Century Roman for American Type Founders in 1900
          so it would meet the standards of the Typographical Union. Benton’s
          Century Expanded is only slightly wider, but was advertised by DeVinne
          as allowing for an expansion in the number of characters that could
          fit in a line, “the expansion is upward, enabling one to get much
          matter in a small space.” Century Expanded is useful for text settings
