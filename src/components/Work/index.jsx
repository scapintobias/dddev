		...
		<main>
			<Grid>
				...
				<Cell
					...
					className="hover-light-purple bg-animate hover-bg-black-10 bl-m bl-l br bt bt-n-m b--navy fl w-25 w-100-m w-100-l pv6"
				/>
				<CellText
				...
				<CellText
					...
					className="hover-green bg-animate hover-bg-black-10 br bb b--navy bt bl-m bb bl-l mb0-l mb0-m fl w-50 w-100-m w-100-l pv5 mb1"
				/>
			</Grid>
		</main>
	);
