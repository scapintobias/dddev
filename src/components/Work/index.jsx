    ...
    <main>
      <Grid>
        <CellText
          ...
          className="hover-white bg-animate b--navy hover-bg-red br-l bb-n-l bt bl bb br-m fl w-50 w-100-m w-100-l h8 pv5"
        />
        ...
        <CellText
          ...
          className="hover-white-50 bg-animate hover-bg-navy bl br bt bt-n-m bb b--navy fl w-50 w-100-m w-100-l pv5"
        />
